...
namespace RogueCastle {
    public class EnemyObj_EarthWizard : EnemyObj {
        ...
        private void InitializeProjectiles() {
            ...
            m_earthProjectileObj.Damage = base.Damage;
            m_earthProjectileObj.Scale = base.ProjectileScale;
        ...
        public void CancelEarthSpell() {
            ...
            Tween.To(m_earthSummonOutSprite, 0.5f, new Easing(Linear.EaseNone), new[] {
                "ScaleX",
                "0",
                "ScaleY",
                "0"
        ...
        public void CancelEarthSpellIn() {
            ...
            Tween.To(m_earthSummonInSprite, 0.5f, new Easing(Linear.EaseNone), new[] {
                "ScaleX",
                "0",
                "ScaleY",
                "0"
        ...
        public void CastEarthSpellIn() {
            ...
            m_earthSummonInSprite.Scale = Vector2.Zero;
            Tween.To(m_earthSummonInSprite, 0.5f, new Easing(Back.EaseOut), new[] {
                "ScaleX",
                "1",
                "ScaleY",
                "1"
        ...
        public void CastEarthSpellOut() {
            ...
            if (terrainObj != null) {
                if (terrainObj.Rotation == 0f)
                    m_earthSummonOutSprite.Y = (float)terrainObj.Bounds.Top;
                else {
                    Vector2 vector;
                    Vector2 vector2;
                    ...
                    num5 -= (float)m_earthSummonOutSprite.Bounds.Bottom - m_earthSummonOutSprite.Y;
        ...
        public override void Update(GameTime gameTime) {
            ...
            if (Flip == SpriteEffects.None)
                m_earthSummonInSprite.Position = new Vector2(base.X + m_spellOffset.X, base.Y + m_spellOffset.Y);
            else
                m_earthSummonInSprite.Position = new Vector2(base.X - m_spellOffset.X, base.Y + m_spellOffset.Y);
        ...
        public void SummonFireball() {
            ...
            Tween.To(m_fireballSummon, 0.5f, new Easing(Back.EaseOut), new[] {
                "Opacity",
                "1",
                "ScaleX",
