    ...
    public class KeyIconTextObj : TextObj {
        ...
        public string AddKeyIcon(string text, int startIndex, int endIndex) {
            ...
            if (text2.Contains("Key")) {
                ...
                keyIconObj.Scale = new Vector2(y / (float)keyIconObj.Height, y / (float)keyIconObj.Height) * ForcedScale;
                m_yOffset = y / 2f;
                string text5 = " ";
                ...
                keyIconObj.Scale = new Vector2(y2 / (float)keyIconObj.Height, y2 / (float)keyIconObj.Height) * ForcedScale;
                m_yOffset = y2 / 2f;
                string text8 = " ";
            ...
            while (i < m_iconList.Count) {
                ...
                switch (this.Align) {
                    ...
                    case Types.TextAlign.Centre:
                        keyIconObj.Position = new Vector2(base.AbsX + m_iconOffset[i] - (this.Width / 2), base.AbsY + m_yOffset);
                        break;
                    case Types.TextAlign.Right:
                        keyIconObj.Position = new Vector2(base.AbsX + m_iconOffset[i] - (float)this.Width, base.AbsY + m_yOffset);
                        break;
                    default:
                        goto IL_A4;
                }
                ...
                continue;
                IL_A4:
                keyIconObj.Position = new Vector2(base.AbsX + m_iconOffset[i], base.AbsY + m_yOffset);
                goto IL_CF;
            }
        }
