...
namespace RogueCastle {
    public class SkillUnlockScreen : Screen {
        ...
        public override void OnEnter() {
            ...
            Tween.To(m_plate, 0.5f, new Easing(Back.EaseOut), new[] {
                "delay",
                "0.3",
                "ScaleX",
                "1",
            ...
            Tween.To(m_picturePlate, 0.3f, new Easing(Tween.EaseNone), new[] {
                "delay",
                "0.4",
                "ScaleX",
                "1",
            ...
            Tween.To(m_picturePlate, 0.1f, new Easing(Tween.EaseNone), new[] {
                "delay",
                "0.4",
                "Opacity",
                "1"
            ...
            Tween.To(m_picture, 0.3f, new Easing(Tween.EaseNone), new[] {
                "delay",
                "0.4",
                "ScaleX",
                "1",
            ...
            Tween.To(m_picture, 0.1f, new Easing(Tween.EaseNone), new[] {
                "delay",
                "0.4",
                "Opacity",
                "1"
        ...
        private void ExitTransition() {
            ...
            Tween.To(m_picture, 0.5f, new Easing(Back.EaseIn), new[] {
                "ScaleX",
                "0",
                "ScaleY",
                "0"
            });
            Tween.To(m_picturePlate, 0.5f, new Easing(Back.EaseIn), new[] {
                "ScaleX",
                "0",
                "ScaleY",
                "0"
            });
            Tween.To(m_titlePlate, 0.5f, new Easing(Back.EaseIn), new[] {
                "ScaleX",
                "0",
                "ScaleY",
                "0"
            });
            Tween.To(m_title, 0.5f, new Easing(Back.EaseIn), new[] {
                "ScaleX",
                "0",
                "ScaleY",
                "0"
            });
            Tween.To(m_plate, 0.5f, new Easing(Back.EaseIn), new[] {
                "ScaleX",
                "0",
                "ScaleY",
                "0"
