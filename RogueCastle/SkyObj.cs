        ...
        private void ShowSilhouette(bool showSanta) {
            if (m_levelScreen != null) {
                ...
                if (flag)
                    ...
                    m_silhouette.X = (float)(m_levelScreen.CurrentRoom.Width + m_silhouette.Width);
                }
                m_silhouette.Y = CDGMath.RandomFloat(100f, 500f);
                int num = m_levelScreen.CurrentRoom.Bounds.Width + m_silhouette.Width * 2;
                if (!flag)
                    num = -num;
                Tween.By(m_silhouette, CDGMath.RandomFloat(10f, 15f), new Easing(Tween.EaseNone), new[] {
                    "X",
                    num.ToString(),
                    "Y",
