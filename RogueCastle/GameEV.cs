namespace RogueCastle {
    internal class GameEV {
        ...
        static GameEV() {
            ...
            GameEV.BRONZECHEST_ITEMDROP_CHANCE = new[] {
                85,
                0,
                15
            };
            GameEV.SILVERCHEST_ITEMDROP_CHANCE = new[] {
                22,
                5,
                73
            };
            GameEV.GOLDCHEST_ITEMDROP_CHANCE = new[] {
                0,
                20,
                80
            };
            GameEV.STATDROP_CHANCE = new[] {
                15,
                15,
                15,
                25,
