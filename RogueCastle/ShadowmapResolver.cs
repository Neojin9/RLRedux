...
namespace RogueCastle {
    public class ShadowmapResolver {
        ...
        public void LoadContent(ContentManager content) {
            ...
            distancesRT = new RenderTarget2D(graphicsDevice, baseSize, baseSize, false, preferredFormat, DepthFormat.None);
            ...
            for (int i = 0; i < reductionChainCount; i++)
                reductionRT[i] = new RenderTarget2D(graphicsDevice, 2 << i, baseSize, false, preferredFormat, DepthFormat.None);
