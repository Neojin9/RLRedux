...
namespace RogueCastle {
    public class GetItemScreen : Screen {
        ...
        public override void OnEnter() {
            ...
            m_itemStartPos.X = m_itemStartPos.X - base.Camera.TopLeftCorner.X;
            m_itemStartPos.Y = m_itemStartPos.Y - base.Camera.TopLeftCorner.Y;
        ...
        private void ItemSpinAnimation() {
            ...
            m_itemSprite.Scale = new Vector2(35f / (float)m_itemSprite.Height, 35f / (float)m_itemSprite.Height);
            Tween.By(m_itemSprite, 0.5f, new Easing(Back.EaseOut), new[] {
                "Y",
                "-150"
            });
            ...
            Tween.By(m_tripStat1, 0.5f, new Easing(Back.EaseOut), new[] {
                "Y",
                "-150",
                "X",
                "50"
            });
            m_tripStat1.Scale = new Vector2(35f / (float)m_tripStat1.Height, 35f / (float)m_tripStat1.Height);
            Tween.By(m_tripStat2, 0.5f, new Easing(Back.EaseOut), new[] {
                "Y",
                "-150",
                "X",
                "-50"
            });
            m_tripStat2.Scale = new Vector2(35f / (float)m_tripStat2.Height, 35f / (float)m_tripStat2.Height);
        }
        ...
        public void ItemSpinAnimation2() {
            ...
            Tween.To(m_itemSprite, 0.2f, new Easing(Quad.EaseOut), new[] {
                "ScaleX",
                "0.1",
                "ScaleY",
                "0.1"
            ...
            Tween.To(m_tripStat1, 0.2f, new Easing(Quad.EaseOut), new[] {
                "ScaleX",
                "0.1",
                "ScaleY",
                "0.1"
            });
            Tween.To(m_tripStat2, 0.2f, new Easing(Quad.EaseOut), new[] {
                "ScaleX",
                "0.1",
                "ScaleY",
                "0.1"
        ...
        public void ItemSpinAnimation3() {
            ...
            m_itemSprite.Scale = Vector2.One;
            float num = 130f / (float)m_itemSprite.Height;
            m_itemSprite.Scale = scale;
            Tween.To(m_itemSprite, 0.2f, new Easing(Tween.EaseNone), new[] {
                "ScaleX",
                num.ToString(),
                "ScaleY",
                num.ToString()
            ...
            Tween.To(m_itemFoundText, 0.3f, new Easing(Back.EaseOut), new[] {
                "ScaleX",
                "1",
                "ScaleY",
                "1"
            });
            Tween.To(m_continueText, 0.3f, new Easing(Linear.EaseNone), new[] {
                "Opacity",
                "1"
            });
            scale = m_tripStat1.Scale;
            m_tripStat1.Scale = Vector2.One;
            num = 130f / (float)m_tripStat1.Height;
            m_tripStat1.Scale = scale;
            Tween.To(m_tripStat1, 0.2f, new Easing(Tween.EaseNone), new[] {
                "ScaleX",
                num.ToString(),
                "ScaleY",
                num.ToString()
            ...
            m_tripStat2.Scale = Vector2.One;
            num = 130f / (float)m_tripStat2.Height;
            m_tripStat2.Scale = scale;
            Tween.To(m_tripStat2, 0.2f, new Easing(Tween.EaseNone), new[] {
                "ScaleX",
                num.ToString(),
                "ScaleY",
                num.ToString()
            ...
            Tween.To(m_tripStat1FoundText, 0.3f, new Easing(Back.EaseOut), new[] {
                "ScaleX",
                "1",
                "ScaleY",
                "1"
            });
            Tween.To(m_tripStat2FoundText, 0.3f, new Easing(Back.EaseOut), new[] {
                "ScaleX",
                "1",
                "ScaleY",
                "1"
            ...
            for (int i = 0; i < m_levelUpParticles.Length; i++) {
                ...
                m_levelUpParticles[i].Position += new Vector2((float)CDGMath.RandomInt(-100, 100), (float)CDGMath.RandomInt(-50, 50));
                float duration = CDGMath.RandomFloat(0f, 0.5f);
                Tween.To(m_levelUpParticles[i], 0.2f, new Easing(Linear.EaseNone), new[] {
                    "delay",
                    duration.ToString(),
                    "Opacity",
                    "1"
                });
                Tween.To(m_levelUpParticles[i], 0.5f, new Easing(Linear.EaseNone), new[] {
                    "delay",
                    duration.ToString(),
                    "ScaleX",
                    "2",
            ...
            Tween.To(m_itemFoundSprite, 0.5f, new Easing(Back.EaseOut), new[] {
                "delay",
                "0.05",
                "ScaleX",
                "1",
            ...
            Tween.To(m_levelUpBGImage, 0.5f, new Easing(Back.EaseOut), new[] {
                "ScaleX",
                "1",
                "ScaleY",
                "1"
        ...
        public void ExitScreenTransition() {
            ...
            Tween.To(m_itemSprite, 0.4f, new Easing(Back.EaseIn), new[] {
                "ScaleX",
                "0",
                "ScaleY",
                "0"
            });
            Tween.To(m_itemFoundText, 0.4f, new Easing(Back.EaseIn), new[] {
                "delay",
                "0.1",
                "ScaleX",
                "0",
            ...
            Tween.To(this, 0.4f, new Easing(Back.EaseIn), new[] {
                "BackBufferOpacity",
                "0"
            });
            Tween.To(m_levelUpBGImage, 0.4f, new Easing(Back.EaseIn), new[] {
                "ScaleX",
                "0",
                "ScaleY",
                "0"
            });
            Tween.To(m_itemFoundSprite, 0.4f, new Easing(Back.EaseIn), new[] {
                "delay",
                "0.1",
                "ScaleX",
                "0",
            ...
            Tween.To(m_tripStat1, 0.4f, new Easing(Back.EaseIn), new[] {
                "ScaleX",
                "0",
                "ScaleY",
                "0"
            });
            Tween.To(m_tripStat2, 0.4f, new Easing(Back.EaseIn), new[] {
                "ScaleX",
                "0",
                "ScaleY",
                "0"
            });
            Tween.To(m_tripStat1FoundText, 0.4f, new Easing(Back.EaseIn), new[] {
                "delay",
                "0.1",
                "ScaleX",
                "0",
            ...
            Tween.To(m_tripStat2FoundText, 0.4f, new Easing(Back.EaseIn), new[] {
                "delay",
                "0.1",
                "ScaleX",
                "0",
        ...
        public override void Draw(GameTime gameTime) {
            ...
            m_levelUpBGImage.Draw(base.Camera);
            ...
            m_itemFoundSprite.Draw(base.Camera);
            m_itemFoundText.Draw(base.Camera);
            m_tripStat1FoundText.Draw(base.Camera);
            m_tripStat2FoundText.Draw(base.Camera);
            base.Camera.GraphicsDevice.SamplerStates[0] = SamplerState.PointClamp;
            m_itemSprite.Draw(base.Camera);
            m_tripStat1.Draw(base.Camera);
            m_tripStat2.Draw(base.Camera);
