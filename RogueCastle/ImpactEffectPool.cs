...
namespace RogueCastle {
    public class ImpactEffectPool : IDisposableObj {
        ...
        public void DisplayEnemyImpactEffect(Vector2 position) {
            ...
            spriteObj.TextureColor = Color.White;
            spriteObj.Rotation = (float)CDGMath.RandomInt(0, 360);
            spriteObj.Visible = true;
            spriteObj.Position = position;
            spriteObj.PlayAnimation(false);
        }
        ...
        public void DisplayDeathEffect(Vector2 position) {
            for (int i = 0; i < 10; i++) {
                ...
                spriteObj.Rotation = (float)CDGMath.RandomInt(0, 90);
                spriteObj.PlayAnimation(true);
                float num3 = CDGMath.RandomFloat(0.5f, 1f);
                float num4 = CDGMath.RandomFloat(0f, 0.1f);
                Tween.To(spriteObj, num3 - 0.2f, new Easing(Linear.EaseNone), new[] {
                    "delay",
                    "0.2",
                    "Opacity",
                    "0"
                });
                Tween.To(spriteObj, num3, new Easing(Back.EaseIn), new[] {
                    "ScaleX",
                    num4.ToString(),
                    "ScaleY",
                    num4.ToString()
                });
                Tween.By(spriteObj, num3, new Easing(Quad.EaseOut), new[] {
                    "X",
                ...
                Tween.By(spriteObj, num3 - 0.1f, new Easing(Quad.EaseOut), new[] {
                    "Rotation",
        ...
        public void DisplayChestSparkleEffect(Vector2 position) {
            ...
            spriteObj.Rotation = (float)CDGMath.RandomInt(0, 90);
            spriteObj.PlayAnimation(false);
            spriteObj.Position += new Vector2((float)CDGMath.RandomInt(-40, 40), (float)CDGMath.RandomInt(-40, 40));
            Tween.To(spriteObj, 0.2f, new Easing(Linear.EaseNone), new[] {
                "Opacity",
                "1"
            });
            Tween.AddEndHandlerToLastTween(spriteObj, "StopAnimation", new object[0]);
        ...
        public void DisplayTeleportEffect(Vector2 position) {
            ...
            for (int i = 0; i < 5; i++) {
                ...
                spriteObj.PlayAnimation(true);
                spriteObj.Position = new Vector2(CDGMath.RandomFloat(position.X - 70f, position.X + 70f), position.Y + (float)CDGMath.RandomInt(-50, -30));
                spriteObj.Opacity = 0f;
                float num2 = 1f;
                Tween.To(spriteObj, 0.5f, new Easing(Linear.EaseNone), new[] {
                    "delay",
                    num.ToString(),
                    "Opacity",
                    "1"
                });
                Tween.By(spriteObj, num2, new Easing(Linear.EaseNone), new[] {
                    "delay",
                    num.ToString(),
                    "Y",
                    "-150"
            ...
            Tween.To(spriteObj2, 0.05f, new Easing(Linear.EaseNone), new[] {
                "ScaleY",
                "1"
            });
        ...
        public void DisplayDustEffect(GameObj obj) {
            ...
            spriteObj.Opacity = 0f;
            spriteObj.Visible = true;
            spriteObj.Rotation = (float)CDGMath.RandomInt(0, 270);
            spriteObj.Position = new Vector2(obj.X, (float)obj.Bounds.Bottom);
            ...
            Tween.By(spriteObj, 0.7f, new Easing(Linear.EaseNone), new[] {
                "Rotation",
                "180"
            });
            Tween.By(spriteObj, 0.7f, new Easing(Quad.EaseOut), new[] {
                "X",
                num.ToString(),
                "Y",
                num2.ToString()
        ...
        public void TurretFireEffect(Vector2 pos, Vector2 scale) {
            ...
            Tween.AddEndHandlerToLastTween(spriteObj, "StopAnimation", new object[0]);
            spriteObj.Opacity = 1f;
            Tween.To(spriteObj, 0.4f, new Easing(Linear.EaseNone), new[] {
                "delay",
                "0.2",
                "Opacity",
                "0"
        ...
        public void StartInverseEmit(Vector2 pos) {
            ...
            for (int i = 0; i < num2; i++) {
                ...
                spriteObj.X = pos.X + (float)CDGMath.RandomInt(-100, 100);
                spriteObj.Y = pos.Y + (float)CDGMath.RandomInt(-100, 100);
                Tween.To(spriteObj, num4, new Easing(Linear.EaseNone), new[] {
                    "ScaleX",
                    "2",
                    "ScaleY",
                    "2"
                });
                Tween.To(spriteObj, num - num4, new Easing(Quad.EaseInOut), new[] {
                    "delay",
                    num4.ToString(),
                    "X",
                    pos.X.ToString(),
        ...
        public void StartTranslocateEmit(Vector2 pos) {
            ...
            for (int i = 0; i < num; i++) {
                ...
                Tween.By(spriteObj, 1f, new Easing(Quad.EaseIn), new[] {
                    "X",
        ...
        public void BlackSmokeEffect(GameObj obj) {
            for (int i = 0; i < 2; i++) {
                ...
                spriteObj.Visible = true;
                spriteObj.Y = obj.Y;
                spriteObj.Y += (float)CDGMath.RandomInt(-40, 40);
                spriteObj.X = (float)obj.Bounds.Left;
                spriteObj.Opacity = 0f;
                spriteObj.PlayAnimation(true);
                spriteObj.Rotation = (float)CDGMath.RandomInt(-30, 30);
                ...
                if (obj.Flip == SpriteEffects.FlipHorizontally) {
                    num = 1;
                    spriteObj.X = (float)obj.Bounds.Right;
                }
                Tween.To(spriteObj, 0.4f, new Easing(Tween.EaseNone), new[] {
                    "Opacity",
                    "1"
                });
                Tween.By(spriteObj, 1.5f, new Easing(Quad.EaseInOut), new[] {
                    "X",
                ...
                spriteObj.Opacity = 1f;
                Tween.To(spriteObj, 1f, new Easing(Tween.EaseNone), new[] {
                    "delay",
                    "0.5",
                    "Opacity",
                    "0"
        ...
        public void BlackSmokeEffect(Vector2 pos, Vector2 scale) {
            ...
            spriteObj.Y += (float)CDGMath.RandomInt(-40, 40);
            spriteObj.X = pos.X;
            spriteObj.X += (float)CDGMath.RandomInt(-40, 40);
            spriteObj.Scale = scale;
            spriteObj.Opacity = 0f;
            spriteObj.PlayAnimation(true);
            spriteObj.Rotation = (float)CDGMath.RandomInt(-30, 30);
        ...
        public void CrowDestructionEffect(Vector2 pos) {
            ...
            for (int j = 0; j < 4; j++) {
                ...
                spriteObj2.X += (float)CDGMath.RandomInt(-20, 20);
                spriteObj2.Y += (float)CDGMath.RandomInt(-20, 20);
                spriteObj2.Opacity = 0f;
                spriteObj2.PlayAnimation(true);
                spriteObj2.Rotation = (float)CDGMath.RandomInt(-30, 30);
                Tween.To(spriteObj2, 0.1f, new Easing(Tween.EaseNone), new[] {
                    "Opacity",
                    "1"
                });
                Tween.By(spriteObj2, 1.5f, new Easing(Quad.EaseInOut), new[] {
                    "X",
                    CDGMath.RandomInt(-50, 50).ToString(),
                    "Y",
                    CDGMath.RandomInt(-50, 50).ToString(),
                ...
                Tween.To(spriteObj2, 1f, new Easing(Tween.EaseNone), new[] {
                    "delay",
                    "0.5",
                    "Opacity",
                    "0"
        ...
        public void CrowSmokeEffect(Vector2 pos) {
            ...
            spriteObj.PlayAnimation(true);
            spriteObj.Rotation = (float)CDGMath.RandomInt(-30, 30);
            Tween.To(spriteObj, 0.2f, new Easing(Tween.EaseNone), new[] {
                "Opacity",
                "1"
            });
            Tween.By(spriteObj, 1f, new Easing(Quad.EaseInOut), new[] {
                "X",
                CDGMath.RandomInt(50, 100).ToString(),
                "Y",
                CDGMath.RandomInt(-100, 100).ToString(),
            ...
            spriteObj.Opacity = 1f;
            Tween.To(spriteObj, 0.5f, new Easing(Tween.EaseNone), new[] {
                "delay",
                "0.5",
                "Opacity",
                "0"
        ...
        public void WoodChipEffect(Vector2 pos) {
            for (int i = 0; i < 5; i++) {
                ...
                spriteObj.Rotation = (float)num;
                Vector2 vector = new Vector2((float)CDGMath.RandomInt(-60, 60), (float)CDGMath.RandomInt(-60, 60));
                Tween.By(spriteObj, 0.3f, new Easing(Tween.EaseNone), new[] {
                    "X",
                    vector.X.ToString(),
                    "Y",
                    vector.Y.ToString()
        ...
        public void MegaTeleport(Vector2 pos, Vector2 scale) {
            ...
            Tween.By(spriteObj, 0.1f, new Easing(Tween.EaseNone), new[] {
                "delay",
                "0.15",
                "Y",
                "-720"
        ...
        public void DestroyFireballBoss(Vector2 pos) {
            ...
            for (int i = 0; i < 15; i++) {
                ...
                Tween.By(spriteObj, 1.5f, new Easing(Quad.EaseOut), new[] {
                    "X",
        ...
        public void SkillTreeDustEffect(Vector2 pos, bool horizontal, float length) {
            ...
            for (int i = 0; i < num; i++) {
                ...
                spriteObj.Rotation = (float)CDGMath.RandomInt(0, 270);
                spriteObj.Position = pos + zero * scaleFactor * (float)(i + 1);
                spriteObj.PlayAnimation(true);
                Tween.To(spriteObj, 0.5f, new Easing(Linear.EaseNone), new[] {
                    "Opacity",
                    "1"
                });
                Tween.By(spriteObj, 1.5f, new Easing(Linear.EaseNone), new[] {
                    "Rotation",
                ...
                Tween.To(spriteObj, 1.5f, new Easing(Quad.EaseOut), new[] {
                    "ScaleX",
                    num4.ToString(),
                    "ScaleY",
                    num4.ToString()
                ...
                Tween.AddEndHandlerToLastTween(spriteObj, "StopAnimation", new object[0]);
                spriteObj.Opacity = 1f;
                Tween.To(spriteObj, 0.7f, new Easing(Linear.EaseNone), new[] {
                    "delay",
                    "0.6",
                    "Opacity",
                    "0"
        ...
        public void SkillTreeDustDuration(Vector2 pos, bool horizontal, float length, float duration) {
            ...
            for (int i = 0; i < num2; i++) {
                Tween.RunFunction(num * (float)i, this, "SkillTreeDustEffect", new object[] {
                    pos,
                    horizontal,
                    length
                });
        ...
        public void CarnivalGoldEffect(Vector2 startPos, Vector2 endPos, int numCoins) {
            ...
            for (int i = 0; i < numCoins; i++) {
                ...
                Tween.By(spriteObj, 0.3f, new Easing(Quad.EaseInOut), new[] {
                    "X",
                    num2.ToString(),
                    "Y",
                    num3.ToString()
                });
                spriteObj.X += (float)num2;
                spriteObj.Y += (float)num3;
                Tween.To(spriteObj, 0.5f, new Easing(Quad.EaseIn), new[] {
                    "delay",
                    num.ToString(),
                    "X",
                    endPos.X.ToString(),
        ...
        public void AssassinCastEffect(Vector2 pos) {
            ...
            for (int i = 0; i < num; i++) {
                ...
                spriteObj.Rotation = (float)CDGMath.RandomInt(-30, 30);
                vector.X += (float)CDGMath.RandomInt(-5, 5);
                vector.Y += (float)CDGMath.RandomInt(-5, 5);
                Tween.To(spriteObj, 0.1f, new Easing(Tween.EaseNone), new[] {
                    "Opacity",
                    "0.5"
                });
                Tween.By(spriteObj, 1f, new Easing(Quad.EaseOut), new[] {
                    "X",
                    (vector.X * (float)CDGMath.RandomInt(20, 25)).ToString(),
                    "Y",
                    (vector.Y * (float)CDGMath.RandomInt(20, 25)).ToString(),
                    "Rotation",
                    CDGMath.RandomInt(-180, 180).ToString()
                });
                Tween.AddEndHandlerToLastTween(spriteObj, "StopAnimation", new object[0]);
        ...
        public void NinjaDisappearEffect(GameObj obj) {
            ...
            spriteObj.PlayAnimation(true);
            Tween.By(spriteObj, 0.3f, new Easing(Quad.EaseIn), new[] {
                "delay",
                "0.2",
                "Y",
                "50"
        ...
        public void DisplayCriticalText(Vector2 position) {
            ...
            spriteObj.Visible = true;
            spriteObj.Rotation = (float)CDGMath.RandomInt(-20, 20);
            spriteObj.Position = CDGMath.GetCirclePosition(spriteObj.Rotation - 90f, 20f, position);
            spriteObj.Scale = Vector2.Zero;
            spriteObj.PlayAnimation(true);
            Tween.To(spriteObj, 0.2f, new Easing(Back.EaseOutLarge), new[] {
                "ScaleX",
                "1",
                "ScaleY",
                "1"
        ...
        public void DisplayTanookiEffect(GameObj obj) {
            for (int i = 0; i < 10; i++) {
                ...
                spriteObj.Visible = true;
                spriteObj.Position = obj.Position;
                spriteObj.X += (float)CDGMath.RandomInt(-30, 30);
                spriteObj.Y += (float)CDGMath.RandomInt(-30, 30);
                float num = CDGMath.RandomFloat(0.7f, 0.8f);
                int num2 = 50;
                spriteObj.Scale = new Vector2(num, num);
                spriteObj.Rotation = (float)CDGMath.RandomInt(0, 90);
        ...
        public void DisplayIceParticleEffect(GameObj sprite) {
            ...
            spriteObj.Visible = true;
            spriteObj.Scale = Vector2.Zero;
            spriteObj.Position = new Vector2((float)CDGMath.RandomInt(sprite.Bounds.Left, sprite.Bounds.Right), (float)CDGMath.RandomInt(sprite.Bounds.Top, sprite.Bounds.Bottom));
            spriteObj.Opacity = 0f;
            Tween.To(spriteObj, 0.1f, new Easing(Tween.EaseNone), new[] {
                "Opacity",
                "1"
            });
            Tween.To(spriteObj, 0.9f, new Easing(Tween.EaseNone), new[] {
                "ScaleX",
                "2.5",
                "ScaleY",
                "2.5"
            });
            Tween.By(spriteObj, 0.9f, new Easing(Tween.EaseNone), new[] {
                "Rotation",
            ...
            Tween.By(spriteObj, 0.2f + num, new Easing(Tween.EaseNone), new[] {
                "X",
                CDGMath.RandomInt(-20, 20).ToString(),
                "Y",
                CDGMath.RandomInt(-20, 20).ToString()
        ...
        public void DisplayEarthParticleEffect(GameObj sprite) {
            ...
            Tween.By(spriteObj, 0.2f + num2, new Easing(Tween.EaseNone), new[] {
                "Y",
        ...
        public void DisplayFountainShatterSmoke(GameObj sprite) {
            int num = 15;
            float num2 = (float)sprite.Width / num;
            float num3 = (float)sprite.Bounds.Left;
            for (int i = 0; i < num; i++) {
                SpriteObj spriteObj = m_resourcePool.CheckOut();
                ...
                Tween.By(spriteObj, 4f, new Easing(Tween.EaseNone), new[] {
                    "Rotation",
                    CDGMath.RandomInt(-40, 40).ToString()
                });
                Tween.By(spriteObj, 3f, new Easing(Tween.EaseNone), new[] {
                    "X",
                    CDGMath.RandomInt(-20, 20).ToString(),
                    "Y",
                    CDGMath.RandomInt(-50, -30).ToString()
                });
                Tween.To(spriteObj, 3f, new Easing(Tween.EaseNone), new[] {
                    "ScaleX",
                    num4.ToString(),
                    "ScaleY",
                    num4.ToString()
                ...
                spriteObj.Opacity = 1f;
                Tween.To(spriteObj, 2f, new Easing(Tween.EaseNone), new[] {
                    "delay",
            ...
            for (int j = 0; j < num; j++) {
                ...
                Tween.To(spriteObj2, 0.5f, new Easing(Tween.EaseNone), new[] {
                    "Opacity",
                    "1"
                });
                Tween.By(spriteObj2, 4f, new Easing(Tween.EaseNone), new[] {
                    "Rotation",
                    CDGMath.RandomInt(-180, 180).ToString()
                });
                Tween.By(spriteObj2, 3f, new Easing(Tween.EaseNone), new[] {
                    "X",
                    CDGMath.RandomInt(-20, 20).ToString(),
                    "Y",
                    CDGMath.RandomInt(-50, -30).ToString()
                });
                Tween.To(spriteObj2, 3f, new Easing(Tween.EaseNone), new[] {
                    "ScaleX",
                    num5.ToString(),
                    "ScaleY",
                    num5.ToString()
                ...
                spriteObj2.Opacity = 1f;
                Tween.To(spriteObj2, 2f, new Easing(Tween.EaseNone), new[] {
                    "delay",
                    CDGMath.RandomFloat(1f, 2f).ToString(),
                    "Opacity",
                    "0"
            ...
            for (int k = 0; k < num; k++) {
                ...
                Tween.To(spriteObj3, 0.5f, new Easing(Tween.EaseNone), new[] {
                    "Opacity",
                    "1"
                });
                Tween.By(spriteObj3, 4f, new Easing(Tween.EaseNone), new[] {
                    "Rotation",
                    CDGMath.RandomInt(-180, 180).ToString()
                });
                Tween.By(spriteObj3, 3f, new Easing(Tween.EaseNone), new[] {
                    "X",
                    CDGMath.RandomInt(-20, 20).ToString(),
                    "Y",
                    CDGMath.RandomInt(-50, -30).ToString()
                });
                Tween.To(spriteObj3, 3f, new Easing(Tween.EaseNone), new[] {
                    "ScaleX",
                    num6.ToString(),
                    "ScaleY",
                    num6.ToString()
                ...
                Tween.To(spriteObj3, 2f, new Easing(Tween.EaseNone), new[] {
                    "delay",
                    CDGMath.RandomFloat(1f, 2f).ToString(),
                    "Opacity",
                    "0"
        ...
        public void DoorSparkleEffect(Rectangle rect) {
            ...
            spriteObj.Scale = new Vector2(num, num);
            spriteObj.Opacity = 0f;
            spriteObj.Position = new Vector2((float)CDGMath.RandomInt(rect.X, rect.X + rect.Width), (float)CDGMath.RandomInt(rect.Y, rect.Y + rect.Height));
            spriteObj.Rotation = (float)CDGMath.RandomInt(0, 90);
            spriteObj.PlayAnimation(false);
            Tween.To(spriteObj, 0.4f, new Easing(Linear.EaseNone), new[] {
                "Opacity",
            ...
            Tween.By(spriteObj, 0.6f, new Easing(Linear.EaseNone), new[] {
                "Rotation",
                CDGMath.RandomInt(-45, 45).ToString(),
                "Y",
                "-50"
