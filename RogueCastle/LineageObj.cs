...
namespace RogueCastle {
    public class LineageObj : ObjContainer {
        ...
        public LineageObj(LineageScreen screen, bool createEmpty = false) {
            ...
            m_playerName.Y = (float)m_textYPos;
            ...
            m_classTextObj.Y = m_playerName.Y + (float)m_playerName.Height - 8f;
            ...
            m_trait1Title.Y = m_classTextObj.Y + (float)m_classTextObj.Height + 5f;
            m_trait1Title.Text = "";
        ...
        public void DropFrame() {
            ...
            Tween.By(m_frameSprite, 0.7f, new Easing(Back.EaseOut), new[] {
                "X",
            ...
            Tween.By(m_playerSprite, 0.7f, new Easing(Back.EaseOut), new[] {
                "X",
                ((-(float)m_frameSprite.Width) / 2f - 2f).ToString(),
                "Y",
                "30",
        ...
        public void DropFrame2() {
            ...
            Tween.By(m_frameSprite, 0.5f, new Easing(Quad.EaseIn), new[] {
                "Y",
                "1000"
            });
            Tween.By(m_playerSprite, 0.5f, new Easing(Quad.EaseIn), new[] {
                "Y",
                "1000"
            });
        }
        ...
        public override void Draw(Camera2D camera) {
            ...
            if (!m_frameDropping) {
                m_frameSprite.Position = base.Position;
                m_frameSprite.Y -= 12f;
                m_frameSprite.X += 5f;
            }
            m_frameSprite.Opacity = base.Opacity;
            ...
            m_playerSprite.OutlineWidth = base.OutlineWidth;
            if (!m_frameDropping) {
                m_playerSprite.Position = base.Position;
            ...
            m_playerSprite.Opacity = base.Opacity;
            ...
            if (!DisablePlaque) {
                if (!m_frameDropping) {
                    m_plaqueSprite.Position = base.Position;
                    m_plaqueSprite.X += 5f;
                    m_plaqueSprite.Y = m_frameSprite.Y + (float)m_frameSprite.Height - 30f;
                }
