    ...
    public class WordBuilder {
        ...
        public static string BuildDungeonName(GameTypes.LevelType levelType) {
            ...
            switch (levelType) {
                ...
                case GameTypes.LevelType.CASTLE:  return "Castle Hamson";
                case GameTypes.LevelType.GARDEN:  return "Forest Abkhazia";
                case GameTypes.LevelType.DUNGEON: return "The Land of Darkness";
                case GameTypes.LevelType.TOWER:   return "The Maya";
                default:                          return "";
