...
namespace RogueCastle {
    public class BlacksmithScreen : Screen {
        ...
        private void InitializeTextObjs() {
            ...
            m_textInfoTitleContainer.Position = new Vector2(m_blacksmithUI.X + 205f, m_blacksmithUI.Y - (float)(m_blacksmithUI.Height / 2) + 45f);
            ...
            m_addPropertiesTitleText.Position = new Vector2(m_blacksmithUI.X + 140f, (m_textInfoStatModContainer.Bounds.Bottom + 5));
            m_addPropertiesText.Position = new Vector2(m_addPropertiesTitleText.X, (float)m_addPropertiesTitleText.Bounds.Bottom);
        ...
        private void DisplayCategory(int equipmentType) {
            ...
            if (m_activeIconArray != null) {
                for (int i = 0; i < 15; i++) {
                    ...
                    Tween.To(m_activeIconArray[i], duration, new Easing(Back.EaseIn), new[] {
                        "delay",
                        num.ToString(),
                        "ScaleX",
                        "0",
            ...
            num = 0.2f;
            for (int j = 0; j < 15; j++) {
                Tween.To(m_activeIconArray[j], duration, new Easing(Back.EaseOut), new[] {
                    "delay",
                    num.ToString(),
                    "ScaleX",
                    "1",
            ...
            foreach (SpriteObj current in m_newIconList) {
                ...
                Tween.To(current, duration, new Easing(Back.EaseOut), new[] {
                    "delay",
                    num.ToString(),
                    "ScaleX",
                    "1",
            ...
            Tween.To(m_equippedIcon, duration, new Easing(Back.EaseOut), new[] {
                "delay",
                num.ToString(),
                "ScaleX",
                "1",
        ...
        public void EaseInMenu() {
            float duration = 0.4f;
            Tween.To(m_blacksmithUI.GetChildAt(0), duration, new Easing(Back.EaseOut), new[] {
                "ScaleX",
                "1",
                "ScaleY",
                "1"
            });
            Tween.To(m_selectionIcon, duration, new Easing(Back.EaseOut), new[] {
                "delay",
                "0.25",
                "ScaleX",
                "1",
            ...
            for (int i = 6; i < m_blacksmithUI.NumChildren - 3; i++) {
                num += 0.05f;
                Tween.To(m_blacksmithUI.GetChildAt(i), duration, new Easing(Back.EaseOut), new[] {
                    "delay",
                    num.ToString(),
                    "ScaleX",
                    "1",
            ...
            Tween.To(m_blacksmithUI.GetChildAt(m_blacksmithUI.NumChildren - 1), duration, new Easing(Back.EaseOut), new[] {
                "delay",
                num.ToString(),
                "ScaleX",
                "1",
            ...
            Tween.To(m_blacksmithUI.GetChildAt(m_blacksmithUI.NumChildren - 2), duration, new Easing(Back.EaseOut), new[] {
                "delay",
                num.ToString(),
                "ScaleX",
                "1",
            ...
            Tween.To(m_blacksmithUI.GetChildAt(m_blacksmithUI.NumChildren - 3), duration, new Easing(Back.EaseOut), new[] {
                "delay",
                num.ToString(),
                "ScaleX",
                "1",
        ...
        private void EaseOutMenu() {
            ...
            Tween.To(m_confirmText, 0.2f, new Easing(Linear.EaseNone), new[] {
                "Opacity",
                "0"
            });
            Tween.To(m_cancelText, 0.2f, new Easing(Linear.EaseNone), new[] {
                "Opacity",
                "0"
            });
            Tween.To(m_navigationText, 0.2f, new Easing(Linear.EaseNone), new[] {
                "Opacity",
                "0"
            });
            float num = 0.4f;
            float num2 = 0f;
            Tween.To(m_blacksmithUI.GetChildAt(m_blacksmithUI.NumChildren - 2), num, new Easing(Back.EaseIn), new[] {
                "ScaleX",
                "0",
                "ScaleY",
                "0"
            });
            Tween.To(m_blacksmithUI.GetChildAt(m_blacksmithUI.NumChildren - 3), num, new Easing(Back.EaseIn), new[] {
                "ScaleX",
                "0",
                "ScaleY",
                "0"
            });
            Tween.To(m_blacksmithUI.GetChildAt(m_blacksmithUI.NumChildren - 4), num, new Easing(Back.EaseIn), new[] {
                "ScaleX",
                "0",
                "ScaleY",
                "0"
            ...
            for (int i = 6; i < 11; i++) {
                if (m_currentCategoryIndex == i) {
                    Tween.To(m_selectionIcon, num, new Easing(Back.EaseIn), new[] {
                        "delay",
                        num2.ToString(),
                        "ScaleX",
                        "0",
                ...
                Tween.To(m_blacksmithUI.GetChildAt(i), num, new Easing(Back.EaseIn), new[] {
                    "delay",
                    num2.ToString(),
                    "ScaleX",
                    "0",
            ...
            for (int k = 0; k < m_activeIconArray.Length; k++) {
                Tween.To(m_activeIconArray[k], num, new Easing(Back.EaseIn), new[] {
                    "ScaleX",
                    "0",
                    "ScaleY",
                    "0"
            ...
            Tween.To(m_blacksmithUI.GetChildAt(0), num, new Easing(Back.EaseIn), new[] {
                "delay",
                "0.3",
                "ScaleX",
                "0",
            ...
            for (int i = 0; i < Game.PlayerStats.GetBlueprintArray.Count; i++) {
                for (int j = 0; j < Game.PlayerStats.GetBlueprintArray[i].Length; j++) {
                    ...
                    if (b == 0)
                        ...
                        m_masterIconArray[i][j].ChangeSprite("BlacksmithUI_" + EquipmentCategoryType.ToString(i) + (j % 5 + 1).ToString() + "Icon_Character");
        ...
        private void UpdateNewIcons() {
            ...
            if (b2 > -1) {
                m_equippedIcon.Position = new Vector2(m_activeIconArray[b2].AbsPosition.X + 18f, m_activeIconArray[b2].AbsPosition.Y + 18f);
        ...
        public override void OnEnter() {
            ...
            DisplayCategory(0);
            EaseInMenu();
            Tween.To(this, 0.2f, new Easing(Linear.EaseNone), new[] {
                "BackBufferOpacity",
                "0.5"
            });
            ...
            if (Game.GlobalInput.JustPressed(0) || Game.GlobalInput.JustPressed(1)) {
                ...
                if (num2 < 3 && num2 > 0) {
                    ...
                    if (Game.PlayerStats.Gold >= equipmentData.Cost) {
                        ...
                        objContainer.ChangeSprite("BlacksmithUI_" + EquipmentCategoryType.ToString(num) + (m_currentEquipmentIndex % 5 + 1).ToString() + "Icon_Character");
        ...
        private void UpdateIconSelectionText() {
            ...
            if (Game.PlayerStats.GetBlueprintArray[m_currentCategoryIndex - 6][m_currentEquipmentIndex] < 3) {
                ...
                (m_unlockCostContainer.GetChildAt(1) as TextObj).Text = Game.EquipmentSystem.GetEquipmentData(m_currentCategoryIndex - 6, m_currentEquipmentIndex).Cost.ToString() + " to unlock";
        ...
        private void UpdateEquipmentDataText() {
            ...
            if (secondaryAttribute != null) {
                ...
                m_addPropertiesText.Text = "None";
            m_equipmentTitleText.Text = EquipmentBaseType.ToString(m_currentEquipmentIndex) + " " + EquipmentCategoryType.ToString(num);
        }
        ...
        public override void Draw(GameTime gameTime) {
            ...
            m_blacksmithUI.Draw(base.Camera);
            m_selectionIcon.Draw(base.Camera);
            m_textInfoTitleContainer.Draw(base.Camera);
            m_textInfoStatContainer.Draw(base.Camera);
            m_textInfoStatModContainer.Draw(base.Camera);
            m_addPropertiesTitleText.Draw(base.Camera);
            m_addPropertiesText.Draw(base.Camera);
            m_unlockCostContainer.Draw(base.Camera);
            m_equipmentTitleText.Draw(base.Camera);
            foreach (ObjContainer[] current in m_masterIconArray) {
            ...
            m_equippedIcon.Draw(base.Camera);
