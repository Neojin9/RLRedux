...
namespace RogueCastle {
    public class JukeboxBonusRoom : BonusRoomObj {
        ...
        public override void Initialize() {
            ...
            m_jukeBox.Y -= 2f;
            m_speechBubble.Position = new Vector2(m_jukeBox.X, m_jukeBox.Y - (float)m_speechBubble.Height - 20f);
            base.Initialize();
        }
        ...
        public override void Update(GameTime gameTime) {
            if (CollisionMath.Intersects(Player.Bounds, m_jukeBox.Bounds)) {
                ...
                m_speechBubble.Y = m_jukeBox.Y - (float)m_speechBubble.Height - 110f + (float)Math.Sin((Game.TotalGameTime * 20f)) * 2f;
                if (Game.GlobalInput.JustPressed(16) || Game.GlobalInput.JustPressed(17)) {
                    ...
                    Tween.To(m_songTitle, 0.5f, new Easing(Linear.EaseNone), new[] {
                        "delay",
                        "0.2",
                        "Opacity",
                        "1"
                    ...
                    m_songTitle.Opacity = 0f;
                    Tween.To(m_nowPlayingText, 0.5f, new Easing(Linear.EaseNone), new[] {
                        "Opacity",
                        "1"
                    });
        ...
        public void AnimateJukebox() {
            Tween.To(m_jukeBox, 0.2f, new Easing(Tween.EaseNone), new[] {
                "ScaleY",
                "2.9",
                "ScaleX",
                "3.1",
            ...
            Player.AttachedLevel.ImpactEffectPool.DisplayMusicNote(new Vector2((float)(m_jukeBox.Bounds.Center.X + CDGMath.RandomInt(-20, 20)), (float)(m_jukeBox.Bounds.Top + CDGMath.RandomInt(0, 20))));
        }
        ...
        public override void Draw(Camera2D camera) {
            m_songTitle.Position = new Vector2(base.X + 1320f - 50f, base.Y + 720f - 150f);
