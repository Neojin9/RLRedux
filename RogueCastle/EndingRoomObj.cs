...
namespace RogueCastle {
    internal class EndingRoomObj : RoomObj {
        ...
        public override void LoadContent(GraphicsDevice graphics) {
            ...
            m_endingMask.Scale = new Vector2(1330f / (float)m_endingMask.Width, 730f / (float)m_endingMask.Height);
            ...
            foreach (EnemyObj current3 in base.EnemyList) {
                ...
                if (spriteObj.ScaleY < 1f)
                    spriteObj.ScaleY = 1f;
                spriteObj.Position = new Vector2(current3.X, current3.Bounds.Top + (float)current3.Height / 2f);
        ...
        public void ChangeLevelType() {
            ...
            Player.AttachedLevel.UpdateLevel(base.LevelType);
        }
