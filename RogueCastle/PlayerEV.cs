namespace RogueCastle {
    internal class PlayerEV {
        public const float KNIGHT_DAMAGE_MOD = 1f;
        ...
        public const float ASSASSIN_MANA_MOD = 0.65f;
        ...
        public const float MAGE_MAGICDAMAGE_MOD = 1.25f;
        ...
        public const float DRAGON_HEALTH_MOD = 0.4f;
        public const float DRAGON_MANA_MOD = 0.25f;
        public const float DRAGON_MOVESPEED_MOD = 0f;
        public const float TRAITOR_HEALTH_MOD = 0.7f;
        public const float TRAITOR_MANA_MOD = 0.7f;
        public const float TRAITOR_CLOSE_MANACOST = 30f;
        public const float TRAITOR_CLOSE_DAMAGEMOD = 1f;
        public const float TRAITOR_AXE_MANACOST = 30f;
        public const float TRAITOR_AXE_DAMAGEMOD = 1f;
    }
}
