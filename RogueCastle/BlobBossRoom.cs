...
namespace RogueCastle {
    public class BlobBossRoom : BossRoomObj {
        ...
        public override bool BossKilled {
            get { return base.ActiveEnemies == 0; }
        }
        ...
        public override void Initialize() {
            m_boss1 = (base.EnemyList[0] as EnemyObj_Blob);
        ...
        public override void OnEnter() {
            ...
            Tween.By(m_blobArray[0], 1f, new Easing(Quad.EaseIn), new[] {
                "delay",
                "0.5",
                "Y",
                "1150"
            ...
            Tween.By(m_blobArray[1], 1f, new Easing(Quad.EaseIn), new[] {
                "delay",
                "1.5",
                "Y",
                "1150"
        ...
        public void DropBlobs() {
            ...
            for (int i = 2; i < m_blobArray.Count; i++) {
                Tween.By(m_blobArray[i], 1f, new Easing(Quad.EaseIn), new[] {
                    "delay",
                    num.ToString(),
                    "Y",
                    "1150"
