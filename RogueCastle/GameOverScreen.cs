...
namespace RogueCastle {
    public class GameOverScreen : Screen {
        ...
        public override void PassInData(List<object> objList) {
            if (objList != null) {
                ...
                if (m_playerFallSound == null) {
                    m_playerFallSound = new FrameSoundObj(m_player, 14, new[] {
                        "Player_Death_BodyFall"
                    });
                    m_playerSwordSpinSound = new FrameSoundObj(m_player, 2, new[] {
                        "Player_Death_SwordTwirl"
                    });
                    m_playerSwordFallSound = new FrameSoundObj(m_player, 9, new[] {
        ...
        public override void OnEnter() {
            ...
            m_playerGhost.Position = new Vector2(m_player.X - (float)(m_playerGhost.Width / 2), (m_player.Bounds.Top - 20));
        ...
        public void DropStats() {
            ...
            if (m_enemyList != null) {
                foreach (EnemyObj current in m_enemyList) {
                    ...
                    Tween.To(current, 0f, new Easing(Tween.EaseNone), new[] {
                        "delay",
                        num.ToString(),
                        "Opacity",
                        "1"
        ...
        public override void HandleInput() {
            if (!m_lockControls && m_droppingStats && (Game.GlobalInput.JustPressed(0) || Game.GlobalInput.JustPressed(1) || Game.GlobalInput.JustPressed(2) || Game.GlobalInput.JustPressed(3))) {
        ...
        public override void Draw(GameTime gameTime) {
            ...
            if (m_playerGhost.Opacity > 0f)
                m_playerGhost.X += (float)Math.Sin((Game.TotalGameTime * 5f)) * 60f * (float)gameTime.ElapsedGameTime.TotalSeconds;
