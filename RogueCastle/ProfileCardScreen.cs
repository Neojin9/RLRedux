...
namespace RogueCastle {
    public class ProfileCardScreen : Screen {
        ...
        public override void LoadContent() {
            ...
            m_backCard.Position = new Vector2(m_frontCard.X + (float)m_backCard.Width + 100f, m_frontCard.Y);
        ...
        public override void OnEnter() {
            ...
            Tween.To(m_frontCard, 0.4f, new Easing(Back.EaseOut), new[] {
                "Y",
                "30"
            });
            Tween.To(m_backCard, 0.4f, new Easing(Back.EaseOut), new[] {
                "delay",
                "0.2",
                "Y",
                "30"
        ...
        public void ExitScreenTransition() {
            ...
            Tween.To(m_frontCard, 0.4f, new Easing(Back.EaseIn), new[] {
                "Y",
                "1500"
            });
            Tween.To(m_backCard, 0.4f, new Easing(Back.EaseIn), new[] {
                "delay",
                "0.2",
                "Y",
                "1500"
        ...
        private void LoadFrontCardStats(PlayerObj player) {
            ...
            m_playerStats.Text = (int)((float)player.Damage / 20f) + "/" + (int)((float)player.MaxHealth / 50f);
        ...
        private void LoadBackCardStats(PlayerObj player) {
            ...
            for (int j = 0; j < Game.PlayerStats.GetEquippedArray.Length; j++) {
                ...
                m_equipmentList[j].Y = (float)num2;
            ...
            for (int k = 0; k < m_runeBackTitleList.Count; k++) {
                m_runeBackTitleList[k].Y = (float)num2;
                m_runeBackDescriptionList[k].Y = (float)num2;
            ...
            if (Game.PlayerStats.TimesCastleBeaten > 0) {
                ...
                if (Game.PlayerStats.HasArchitectFee) {
                    m_runeBackDescriptionList[m_runeBackDescriptionList.Count - 1].Y = (float)num2;
                    m_runeBackTitleList[m_runeBackDescriptionList.Count - 1].Y = (float)num2;
                }
            }
        ...
        public override void Draw(GameTime gametime) {
            ...
            m_frontCard.Draw(base.Camera);
            m_backCard.Draw(base.Camera);
            ...
            if (Game.PlayerStats.IsDead) {
                ...
                m_tombStoneSprite.Draw(base.Camera);
            }
            else {
                if (m_playerInAir)
                    m_playerSprite.Position = new Vector2(m_frontCard.X + 180f, m_frontCard.Y + 202f);
                else
                    m_playerSprite.Position = new Vector2(m_frontCard.X + 160f, m_frontCard.Y + 280f - ((float)m_playerSprite.Bounds.Bottom - m_playerSprite.Y));
