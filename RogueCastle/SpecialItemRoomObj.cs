...
namespace RogueCastle {
    public class SpecialItemRoomObj : BonusRoomObj {
        ...
        public override void Initialize() {
            ...
            m_icon.Y = m_pedestal.Y - (m_pedestal.Y - (float)m_pedestal.Bounds.Top) - (float)m_icon.Height / 2f - 10f;
        ...
        public void TakeItem() {
            ...
            list.Add(new Vector2(m_pedestal.X, m_pedestal.Y - (float)m_pedestal.Height / 2f));
            list.Add(5);
