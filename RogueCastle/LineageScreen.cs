...
namespace RogueCastle {
    public class LineageScreen : Screen {
        ...
        public override void LoadContent() {
            ...
            textObj.Position = new Vector2((float)m_descriptionPlate.Width / 2f, 15f);
            ...
            keyIconTextObj2.Position = new Vector2((float)m_descriptionPlate.Width / 2f, 15f);
        ...
        private void AddLineageRow(int numLineages, Vector2 position, bool createEmpty, bool randomizePortrait) {
            ...
            for (int i = 0; i < numLineages; i++) {
                ...
                lineageObj.X = position.X + (float)m_xPosOffset;
                int[] array3 = array;
                if (numLineages == 2)
                    array3 = array2;
            ...
            base.Camera.Position = m_currentPoint;
        ...
        public override void OnEnter() {
            ...
            LoadFamilyTreeData();
            LoadCurrentBranches();
            base.Camera.Position = m_selectedLineageObj.Position;
        ...
        public override void HandleInput() {
            if (!m_lockControls && (m_selectTween == null || (m_selectTween != null && !m_selectTween.Active))) {
                ...
                if (Game.GlobalInput.JustPressed(9) && SkillSystem.GetSkill(SkillType.Randomize_Children).ModifierAmount > 0f && !Game.PlayerStats.RerolledChildren) {
                    ...
                    if (m_xShift != 0) {
                        m_xShift = 0;
                        Tween.By(m_descriptionPlate, 0.2f, new Easing(Back.EaseOut), new[] {
                            "delay",
                            "0.2",
                            "X",
                            "-600"
                        });
                        m_selectTween = Tween.To(base.Camera, 0.3f, new Easing(Quad.EaseOut), new[] {
                            "delay",
                            "0.2",
                            "X",
                ...
                if (Game.GlobalInput.Pressed(20) || Game.GlobalInput.Pressed(21)) {
                    if (base.Camera.X > m_masterArray[0].X + 10f) {
                        SoundManager.PlaySound("frame_swoosh_01");
                        m_selectTween = Tween.By(base.Camera, 0.3f, new Easing(Quad.EaseOut), new[] {
                            "X",
                            (-m_xPosOffset).ToString()
                        });
                        if (m_xShift == 0) {
                            Tween.By(m_descriptionPlate, 0.2f, new Easing(Back.EaseIn), new[] {
                                "X",
                                "600"
                            });
                        }
                ...
                if (m_xShift == 0) {
                    if (Game.GlobalInput.JustPressed(16) || Game.GlobalInput.JustPressed(17)) {
                        ...
                        if (m_selectedLineageIndex != selectedLineageIndex) {
                            UpdateDescriptionPlate();
                            m_selectTween = Tween.By(m_currentBranchArray[0], 0.3f, new Easing(Quad.EaseOut), new[] {
                                "Y",
                                "450"
                            });
                            Tween.By(m_currentBranchArray[1], 0.3f, new Easing(Quad.EaseOut), new[] {
                                "Y",
                                "450"
                            });
                            Tween.By(m_currentBranchArray[2], 0.3f, new Easing(Quad.EaseOut), new[] {
                                "Y",
                                "450"
                            });
                        }
        ...
        public override void Draw(GameTime gameTime) {
            ...
            if (base.Camera.Zoom >= 1f) {
                ...
                m_bgShadow.Draw(base.Camera);
                m_titleText.Draw(base.Camera);
                m_confirmText.Draw(base.Camera);
                m_navigationText.Draw(base.Camera);
                m_rerollText.Draw(base.Camera);
                m_descriptionPlate.Draw(base.Camera);
                base.Camera.End();
            }
            base.Draw(gameTime);
        }
