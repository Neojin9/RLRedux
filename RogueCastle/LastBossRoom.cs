...
namespace RogueCastle {
    public class LastBossRoom : BossRoomObj {
        ...
        public override void Initialize() {
            m_boss = (base.EnemyList[0] as EnemyObj_LastBoss);
        ...
        public void Cutscene2() {
            ...
            Tween.By(Player.AttachedLevel.Camera, 1.5f, new Easing(Quad.EaseInOut), new[] {
                "X",
                "300"
            });
        ...
        public void RunFountainCutscene() {
            ...
            Tween.To(camera, 1f, new Easing(Quad.EaseInOut), new[] {
                "X",
        ...
        public void DisplaySecondBoss() {
            ...
            m_boss.Position = new Vector2(m_fountain.X, m_fountain.Y - ((float)m_boss.Bounds.Bottom - m_boss.Y));
        }
        ...
        public override void Draw(Camera2D camera) {
            base.Draw(camera);
            camera.Draw(Game.GenericTexture, new Rectangle((int)base.X, (int)base.Y, this.Width, this.Height), Color.White * BackBufferOpacity);
        }

        public void ChangeWindowOpacity() {
            foreach (GameObj current in base.GameObjList) {
                if (current.Name == "stainglass") {
                    Tween.To(current, 2f, new Easing(Tween.EaseNone), new[] {
                        "Opacity",
                        "0.2"
                    });
                }
        ...
        private void DropGold() {
            ...
            for (int l = 0; l < list.Count; l++) {
                ...
                if (list[l] == 0) {
                    Tween.RunFunction((float)l * num, Player.AttachedLevel.ItemDropManager, "DropItemWide", new object[] {
                        position,
                        1,
                        10
                    });
