...
namespace RogueCastle {
    ...
    public class BlobChallengeRoom : ChallengeBossRoomObj {
        ...
        public void Intro2() {
            ...
            array[1] = "0.5";
            array[2] = "X";
            array[3] = Bounds.Center.X.ToString();
            array[4] = "Y";
            array[5] = Bounds.Center.Y.ToString();
            array[6] = "Zoom";
            array[7] = "0.5";

            Tween.To(Player.AttachedLevel.Camera, 1f, Quad.EaseInOut, array);
