...
namespace RogueCastle {
    public class MapScreen : Screen {
        ...
        public MapScreen(ProceduralLevelScreen level) {
            ...
            m_alzheimersQuestionMarks.Position = new Vector2(660f, 360f - (float)m_alzheimersQuestionMarks.Height / 2f);
        }
        ...
        public override void LoadContent() {
            m_mapDisplay.InitializeAlphaMap(new Rectangle(50, 50, 1220, 620), base.Camera);
            ...
            textObj.Position = new Vector2((float)(m_legend.Width / 2) * spriteObj.ScaleX, (m_legend.Bounds.Top + 10));
            textObj.Text = "Legend";
        ...
        public override void Draw(GameTime gameTime) {
            ...
            m_mapDisplay.DrawRenderTargets(base.Camera);
            base.Camera.End();
