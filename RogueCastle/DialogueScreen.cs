...
namespace RogueCastle {
    public class DialogueScreen : Screen {
        ...
        public override void LoadContent() {
            ...
            textObj2.Position = new Vector2((-(float)m_dialogContainer.Width) / 2.2f, (-(float)m_dialogContainer.Height) / 1.6f);
            m_dialogContainer.AddChild(textObj);
            textObj.Position = new Vector2((-(float)m_dialogContainer.Width) / 2.15f, (-(float)m_dialogContainer.Height) / 3.5f);
            ...
            spriteObj.Position = new Vector2((float)m_dialogContainer.GetChildAt(2).Bounds.Right, (float)m_dialogContainer.GetChildAt(2).Bounds.Bottom);
            ...
            if (!m_lockControls && m_inputDelayTimer <= 0f) {
                if (!m_dialogChoiceContainer.Visible) {
                    if (Game.GlobalInput.JustPressed(0) || Game.GlobalInput.JustPressed(1) || Game.GlobalInput.JustPressed(2) || Game.GlobalInput.JustPressed(3)) {
                        if (m_dialogCounter < m_dialogText.Length - 1) {
                            ...
                            if (!textObj.IsTypewriting) {
                                ...
                                textObj.WordWrap(850);
                                textObj.BeginTypeWriting((float)m_dialogText[m_dialogCounter].Length * m_textScrollSpeed, "dialogue_tap");
                            }
                            else
                            ...
                            Tween.To(m_dialogContainer, 0.3f, new Easing(Quad.EaseIn), new[] {
                                "Opacity",
                                "0",
                                "Y",
                                "0"
                        ...
                        if (m_dialogCounter == m_dialogText.Length - 1) {
                            ...
                            if (m_runChoiceDialogue) {
                                ...
                                Tween.To(m_dialogChoiceContainer, 0.3f, new Easing(Back.EaseOut), new[] {
                                    "ScaleX",
                                    "1",
                                    "ScaleY",
                                    "1"
                    ...
                    if (Game.GlobalInput.JustPressed(18) || Game.GlobalInput.JustPressed(19)) {
                        ...
                        m_dialogChoiceContainer.GetChildAt(1).Y = m_dialogChoiceContainer.GetChildAt((int)m_highlightedChoice).Y + (float)(m_dialogChoiceContainer.GetChildAt(1).Height / 2) + 3f;
                    }
                    ...
                    if (Game.GlobalInput.JustPressed(0) || Game.GlobalInput.JustPressed(1)) {
                        ...
                        m_lockControls = true;
                        SoundManager.PlaySound("DialogMenuClose");
                        Tween.To(m_dialogContainer, 0.3f, new Easing(Quad.EaseInOut), new[] {
                            "Opacity",
                            "0",
                            "Y",
                            "100"
                        ...
                        Tween.To(m_dialogChoiceContainer, 0.3f, new Easing(Back.EaseIn), new[] {
                            "ScaleX",
                            "0",
                            "ScaleY",
                            "0"
        ...
        public override void Draw(GameTime gameTime) {
            ...
            m_dialogContainer.Draw(base.Camera);
            ...
            m_dialogChoiceContainer.Draw(base.Camera);
            base.Camera.End();
            base.Draw(gameTime);
        }
        ...
        public override void OnEnter() {
            ...
            (m_dialogContainer.GetChildAt(2) as TextObj).BeginTypeWriting((float)dialogue[m_dialogCounter].Length * m_textScrollSpeed, "dialogue_tap");
            Tween.To(m_dialogContainer, 0.3f, new Easing(Quad.EaseInOut), new[] {
                "Opacity",
                "1",
                "Y",
