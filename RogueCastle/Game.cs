...
namespace RogueCastle {
    public class Game : Microsoft.Xna.Framework.Game {
        ...
        protected override void Initialize() {
            ...
            m_physicsManager.Initialize(Game.ScreenManager.Camera);
            ...
            if (!(Game.ScreenManager.CurrentScreen is CDGSplashScreen) && !(Game.ScreenManager.CurrentScreen is DemoStartScreen)) {
                ...
                if (levelScreen != null) {
                    ...
                    if (challengeBossRoomObj != null) {
                        ...
                        SaveManager.LoadFiles(levelScreen, new[] {
        ...
        public void InitializeScreenConfig() {
            ...
            if ((graphics.IsFullScreen && !Game.GameConfig.FullScreen) || (!graphics.IsFullScreen && Game.GameConfig.FullScreen))
        ...
        #region Nested type: SettingStruct
