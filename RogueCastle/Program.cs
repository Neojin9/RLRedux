...
namespace RogueCastle {
    ...
    internal static class Program {
        ...
        private static void Main(string[] args) {
            ...
            bool flag = true; //!LevelEV.CREATE_RETAIL_VERSION || SWManager.instance().init(false, false, 241600);
            ...
            MessageBox.Show("Please load Rogue Legacy from the Steam client", "Launch Error", MessageBoxButtons.OK);
