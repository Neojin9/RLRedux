...
namespace RogueCastle {
    public class EnchantressScreen : Screen {
        ...
        private void InitializeTextObjs() {
            ...
            m_instructionsTitleText = new TextObj(null);
            ...
            m_instructionsText = new KeyIconTextObj(null);
            ...
            m_descriptionText.Position = new Vector2(m_enchantressUI.X + 140f, m_enchantressUI.Y - (float)(m_enchantressUI.Height / 2) + 20f + 40f);
            m_instructionsTitleText.Position = new Vector2(m_enchantressUI.X + 140f, (m_descriptionText.Bounds.Bottom + 20));
            m_instructionsText.Position = new Vector2(m_instructionsTitleText.X, (float)m_instructionsTitleText.Bounds.Bottom);
        ...
        public void EaseInMenu() {
            float duration = 0.4f;
            Tween.To(m_enchantressUI.GetChildAt(0), duration, new Easing(Back.EaseOut), new[] {
                "ScaleX",
                "1",
                "ScaleY",
                "1"
            ...
            for (int i = 6; i < m_enchantressUI.NumChildren - 3; i++) {
                num += 0.05f;
                Tween.To(m_enchantressUI.GetChildAt(i), duration, new Easing(Back.EaseOut), new[] {
                    "delay",
                    num.ToString(),
                    "ScaleX",
                    "1",
            ...
            Tween.To(m_enchantressUI.GetChildAt(m_enchantressUI.NumChildren - 1), duration, new Easing(Back.EaseOut), new[] {
                "delay",
                num.ToString(),
                "ScaleX",
                "1",
            ...
            Tween.To(m_enchantressUI.GetChildAt(m_enchantressUI.NumChildren - 2), duration, new Easing(Back.EaseOut), new[] {
                "delay",
                num.ToString(),
                "ScaleX",
                "1",
            ...
            Tween.To(m_enchantressUI.GetChildAt(m_enchantressUI.NumChildren - 3), duration, new Easing(Back.EaseOut), new[] {
                "delay",
                num.ToString(),
                "ScaleX",
                "1",
        ...
        private void EaseOutMenu() {
            ...
            float num = 0.4f;
            float num2 = 0f;
            Tween.To(m_enchantressUI.GetChildAt(m_enchantressUI.NumChildren - 2), num, new Easing(Back.EaseIn), new[] {
                "ScaleX",
                "0",
                "ScaleY",
                "0"
            });
            Tween.To(m_enchantressUI.GetChildAt(m_enchantressUI.NumChildren - 3), num, new Easing(Back.EaseIn), new[] {
                "ScaleX",
                "0",
                "ScaleY",
                "0"
            });
            Tween.To(m_enchantressUI.GetChildAt(m_enchantressUI.NumChildren - 4), num, new Easing(Back.EaseIn), new[] {
                "ScaleX",
                "0",
                "ScaleY",
                "0"
            ...
            for (int i = 6; i < 11; i++) {
                ...
                Tween.To(m_enchantressUI.GetChildAt(i), num, new Easing(Back.EaseIn), new[] {
                    "delay",
                    num2.ToString(),
                    "ScaleX",
                    "0",
            ...
            Tween.To(m_enchantressUI.GetChildAt(0), num, new Easing(Back.EaseIn), new[] {
                "delay",
                "0.3",
                "ScaleX",
                "0",
        ...
        private void UpdateIconSelectionText() {
            ...
            if (Game.PlayerStats.GetRuneArray[m_currentCategoryIndex - 6][m_currentEquipmentIndex] < 3) {
                ...
                (m_unlockCostContainer.GetChildAt(1) as TextObj).Text = Game.EquipmentSystem.GetAbilityCost(m_currentCategoryIndex - 6, m_currentEquipmentIndex).ToString() + " to unlock";
        ...
        public override void Draw(GameTime gameTime) {
            ...
            m_enchantressUI.Draw(base.Camera);
            m_selectionIcon.Draw(base.Camera);
            m_descriptionText.Draw(base.Camera);
            m_instructionsTitleText.Draw(base.Camera);
            m_instructionsText.Draw(base.Camera);
